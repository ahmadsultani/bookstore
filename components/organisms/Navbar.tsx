...
function Navbar({ onLanding }: { onLanding?: boolean }) {
	...
	const bgclass =
		scrollPosition > 720 && "bg-gradient-to-b from-black to-[rgb(0,0,0,0.3)] ";
	const buttonhover = scrollPosition > 720 && "hover:text-green";
	...
	return (
		<nav
			className={` duration-[400ms] z-50 ${onLanding ? "fixed": "sticky"} text-white flex w-[100%] top-0 max-w-[100vw] bg-primary shadow-[0_25px_60px_-15px_rgba(0,0,0,0.6)] ${
				onLanding && bgclass
			} px-[100px] py-[15px]`}
		>
