  ...
  return (
    <>
      ...
      <main className="bg-gradient-to-r from-darkgreen to-primary  w-full h-screen ">
        ...
        <section className="absolute flex flex-col px-20 w-1/2 h-2/3 top-1/2 left-1/2 -translate-x-1/2 -translate-y-[43%] bg-white">
          ...
          <p className="text-primary text-lg text-center mt-4 font-medium">
            Sorry, the page you&apos;re looking for doesn&apos;t exist. You can
            go back to the homepage by clicking the button below.
          </p>
          <Link
            href="/"
            className="bg-darkgreen px-8 py-4 w-fit mx-auto mt-10 rounded-xl text-white text-lg font-semibold"
          >
            RETURN HOME
          </Link>
        </section>
